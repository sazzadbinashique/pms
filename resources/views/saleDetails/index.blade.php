        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table table-hover table-striped" id="product_tbl">
                        ...
                        @foreach($products as $key=>$data)
                            ...
                            <tr>
                                ...
                                <td class="align-middle">{{$data->medicine_category}}</td> 
                                ...
                                <td class="text-center align-middle">
                                    <div class="d-grid gap-2 d-md-flex justify-content-center">
                                        <a class="btn btn-info text-white btn-sm" href="{{ route('products.show',$data->id) }}">Details</a>

                                        @can('user-edit')
                                        <a class="btn btn-primary btn-sm" href="{{ route('products.edit',$data->id) }}">Edit</a>
                                        @endcan
